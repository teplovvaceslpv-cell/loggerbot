...
TOKEN = '8445974927:AAFspktcCUNQtUO7sHhw_6Q3Sos2D_qCPYk'
...
def send_welcome(message):
    ...
    markup.row(
        InlineKeyboardButton('🔰 Создатель', callback_data='authors'),
...
def show_authors(call):
    bot.send_message(call.message.chat.id, "Создатель: @fegice")
